...
C_SRCS += \
../Drivers/ioLibrary/ethernet_init.c \
../Drivers/ioLibrary/ll_SPI_enh_abstractions.c 

OBJS += \
./Drivers/ioLibrary/ethernet_init.o \
./Drivers/ioLibrary/ll_SPI_enh_abstractions.o 

C_DEPS += \
./Drivers/ioLibrary/ethernet_init.d \
./Drivers/ioLibrary/ll_SPI_enh_abstractions.d 


# Each subdirectory must supply rules for building sources it contributes
Drivers/ioLibrary/%.o Drivers/ioLibrary/%.su Drivers/ioLibrary/%.cyclo: ../Drivers/ioLibrary/%.c Drivers/ioLibrary/subdir.mk
...
clean: clean-Drivers-2f-ioLibrary

clean-Drivers-2f-ioLibrary:
	-$(RM) ./Drivers/ioLibrary/ethernet_init.cyclo ./Drivers/ioLibrary/ethernet_init.d ./Drivers/ioLibrary/ethernet_init.o ./Drivers/ioLibrary/ethernet_init.su ./Drivers/ioLibrary/ll_SPI_enh_abstractions.cyclo ./Drivers/ioLibrary/ll_SPI_enh_abstractions.d ./Drivers/ioLibrary/ll_SPI_enh_abstractions.o ./Drivers/ioLibrary/ll_SPI_enh_abstractions.su

.PHONY: clean-Drivers-2f-ioLibrary
